...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: '#4a5568', marginTop: 4, fontWeight: '500' },
  addButton: {
  ...
  addButtonText: { color: '#3B82F6', fontWeight: '700', fontSize: 13 },
  emptyState: { alignItems: 'center', paddingTop: 80 },
  emptyEmoji: { fontSize: 48, marginBottom: 16 },
  emptyTitle: { fontSize: 18, fontWeight: '700', color: '#fff', marginBottom: 8 },
  emptySubtitle: { fontSize: 13, color: '#4a5568', textAlign: 'center', paddingHorizontal: 40, lineHeight: 20 },
  card: {
  ...
  categoryName: { fontSize: 15, fontWeight: '700', color: '#e2e8f0' },
  overBadge: { backgroundColor: 'rgba(248,113,113,0.15)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 20 },
  overBadgeText: { fontSize: 11, color: '#f87171', fontWeight: '600' },
  amountText: { fontSize: 14, fontWeight: '700', color: '#e2e8f0' },
  budgetText: { fontSize: 13, color: '#4a5568', fontWeight: '400' },
  progressTrack: { height: 6, backgroundColor: '#141d35', borderRadius: 3, overflow: 'hidden', marginBottom: 8, marginTop: 10 },
  progressFill: { height: '100%', borderRadius: 3 },
  percentText: { fontSize: 12, fontWeight: '600', textAlign: 'right' },
  ...
  modalLabel: { fontSize: 12, color: '#4a5568', fontWeight: '600', letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 10 },
  categoryChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, backgroundColor: '#141d35', borderWidth: 1, borderColor: 'rgba(59,130,246,0.1)' },
  categoryChipSelected: { backgroundColor: '#3B82F6', borderColor: '#3B82F6' },
  categoryChipText: { fontSize: 13, color: '#4a5568', fontWeight: '600' },
  input: { backgroundColor: '#141d35', borderRadius: 14, padding: 14, color: '#fff', fontSize: 16, borderWidth: 1, borderColor: 'rgba(59,130,246,0.1)', marginBottom: 16 },
  saveButton: { backgroundColor: '#3B82F6', borderRadius: 14, padding: 16, alignItems: 'center' },
